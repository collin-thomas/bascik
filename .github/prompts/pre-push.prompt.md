...
3. Check spelling and web standards across the workspace to prevent typos and compatibility regressions:
...
4. Run unit tests and typechecks across all monorepo packages:
