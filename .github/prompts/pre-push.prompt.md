...
3. Read `docs/src/pages/assets/SKILL.md` and review changes in `docs/content/`. Update SKILL.md to reflect any new, changed, or removed APIs and patterns based on documentation updates. Keep entries concise and practical, only changing what the review reveals needs changing.
