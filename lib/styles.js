// Some functions in this file are deprecated with the add-scoped-js branch
...
export const prefixClassesInHtml = (html, componentName) => {
  // The space is before class is important, 
  // this prevents matching on `data-class` and `class` instead of just `class`
 ...
 */
export const getComponentCssOld = async (
  componentName,
  htmlFileName,
  cssFileNames
) => {
