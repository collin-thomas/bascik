...
export const recursivelyTranspile = (
  ...
  try {
    if (BascikConfig.scopeAttribute.id) component = prefixElementAttribute(component, 'id')
    if (BascikConfig.scopeAttribute.name) component = prefixElementAttribute(component, 'name')
    if (BascikConfig.scopeAttribute.class) component = prefixElementAttribute(component, 'class')
    if (BascikConfig.scopeScriptBlocks) component = namespaceScriptTags(component)
  } catch (error) {
