...
import { copyWithCreatePath, deleteDistDir, deleteDistFile } from "./file-system.js";
...
export const watchFiles = () => {
  ...
  chokidar
    ...
    .on("add", (path) => copyWithCreatePath(path, 'dist'))
    .on("change", (path) => copyWithCreatePath(path, 'dist'))
